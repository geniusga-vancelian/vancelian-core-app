      ...
      <ReactMarkdown
        ...
        components={{
          ...
          img: ({ node, ...props }) => (
            <img
              {...props}
              className="w-full rounded-lg my-4 max-h-64 object-cover"
              alt={props.alt || ""}
            />
          ),
            ...
            if (isVideoLink) {
              return (
                <video
                  src={href}
                  controls
                  className="w-full rounded-lg my-4 max-h-48"
                >
          ...
          blockquote: ({ node, ...props }) => (
            <blockquote
              {...props}
              className="border-l-4 border-gray-300 pl-4 italic text-slate-600 my-4"
            />
          ),
          ...
          code: ({ node, className, ...props }: any) => {
            ...
            return (
              <code
                {...props}
                className="block bg-gray-100 text-gray-800 p-3 rounded overflow-x-auto my-3 text-xs"
              />
            )
          },
          ...
          p: ({ node, ...props }: any) => {
            ...
            return <p {...props} className="my-3" />
          },
          // Headings: better spacing
          h1: ({ node, ...props }) => <h1 {...props} className="text-2xl font-bold mt-6 mb-3" />,
